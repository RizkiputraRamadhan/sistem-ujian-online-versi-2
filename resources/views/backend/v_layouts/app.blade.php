...
<style>
    ...
    .scrollable::-webkit-scrollbar-thumb {
        background-color: #888888; /* Warna garis scroll */
        border-radius: 5px;
    }

    .scrollable::-webkit-scrollbar-track {
        background: transparent; /* Hapus latar belakang bayangan */
    }
</style>
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="{{ url('home') }}">
                        ...
                        <b class="logo-icon p-l-10">
                            <img width="80%" src="{{ asset('storage/logo_sipenting.png') }}" alt="homepage" class="light-logo" />
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ url('/siswa') }}"
                                aria-expanded="false"><i class="mdi mdi-account-key"></i><span
                                    class="hide-menu">Akun Siswa</span></a>
                        </li>

                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ url('/guru') }}" aria-expanded="false"><i class="mdi mdi-account-key"></i><span class="hide-menu">Akun Guru</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ url('/result') }}" aria-expanded="false"><i
                                    class="mdi mdi-chart-areaspline"></i><span class="hide-menu">Hasil Ujian</span></a>
                        </li>

                        @else
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ url('/ujian') }}" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">Ujian</span></a>
                        </li>
                        @endif
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ url('/diskusi') }}" aria-expanded="false"><i class="mdi mdi-comment-multiple-outline"></i><span class="hide-menu">Diskusi</span></a>
                        </li>
                    </ul>
                </nav>
