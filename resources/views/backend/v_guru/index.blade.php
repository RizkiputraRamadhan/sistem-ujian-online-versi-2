    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="card">
                    <form id="createQuestionForm"  style="display: none;" action="guru/store" method="post" class="form-horizontal">
                        @csrf
                    ...
                    <table id="zero_config" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> {{$row->email}} </td>
                                <td align="center">
                                    <a href="{{ url('guru/edit', $row->id) }}" title="Ubah Data">
                                    ...
                                    <form method="POST" action="{{ url('guru/destroy', $row->id) }}" style="display: inline-block;">
                                        @method('delete')
                                        @csrf
